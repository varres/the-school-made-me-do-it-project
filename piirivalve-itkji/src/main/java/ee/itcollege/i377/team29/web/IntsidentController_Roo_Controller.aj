...
privileged aspect IntsidentController_Roo_Controller {
    ...
    public Collection<Isik_intsidendis> IntsidentController.populateIsik_intsidendises() {
        return Isik_intsidendis.findAllIsik_intsidendises();
    }
    
    @ModelAttribute("objekt_intsidendises")
    public Collection<Objekt_intsidendis> IntsidentController.populateObjekt_intsidendises() {
